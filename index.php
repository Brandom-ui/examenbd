...
<div class="row">
<div class="col-lg-6">
<span class="logo">Interline Instituto</span></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:blue">Ingresar</span></h4>
      </div>
...
<a href="https://interline.edu.mx/" target="_blank">Quienes Somos</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     " width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 ...
		 <div class="col-md-5">
     <a href="https://interline.edu.mx/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Accede a mi sitio web">Interline Instituto</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+57 316 243 00 81</h4>
		<h4 style="font-family:'typo' ">interline@interline.edu.mx</h4>
		<h4 style="font-family:'typo' ">Interline Instituto</h4></div></div>
		</p>
      </div>
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:blue;font-family:'typo' ">Ingresar</span></h4>
      </div>
